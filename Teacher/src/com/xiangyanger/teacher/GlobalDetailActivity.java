				...
				new Response.Listener<String>() {
					...
					public void onResponse(String response) {
						...
						try {
							...
							Log.d("education->teacher", "versionName:"+serverVersionName);
				  ...
				  if (url.startsWith("tel:")){
					  ...
					  for(String tmp : spl){
						  ...
						  if(tmp.startsWith("sdkAppid=")){
							  ...
							  CreateRoomActivity.sdkAppid = Integer.parseInt(spli[1]);

						  }else if(tmp.startsWith("accountType=")){

							  CreateRoomActivity.accountType = Integer.parseInt(spli[1]);

						  }else if(tmp.startsWith("roomid=")){

							  CreateRoomActivity.roomid = Integer.parseInt(spli[1]);

						  }else if(tmp.startsWith("indentifer=")){

							  CreateRoomActivity.indentifer = spli[1];

						  }else if(tmp.startsWith("userSig=")){

							  CreateRoomActivity.userSig = spli[1];
